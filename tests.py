...
tab1, tab2, tab3 = st.tabs(
    ["Test 1", "Test 2 (Coming soon)", "Test 3 (Coming soon)"]
)
...
# DataForSEO summaries
    ...
    **Annotation notes**
    ...
    - DataforSEO shows slightly more consistent relevance
    - Not possible to draw conclusion from Test 1 regarding which has more articles
    - Based on Test 1 and previous attempts, very low visibility conflicts seem to not be covered by either (will make further attempt with Test 2 and 3)
